          ...
          <div className="propos-de-moi">
            ...
            <div className="paragraphe-propos">
              <p>
                ...
                suis découvert une passion pour le code. J’ai donc entrepris une
                reconversion professionnelle afin d’apprendre le métier.
                <br />
                <br />
                Au cours de ma formation, j’ai développé de solides compétences
                en HTML, CSS, JavaScript et React. J’ai également mené à bien
                plusieurs projets, notamment la création de sites web à partir
                de maquettes, l’optimisation des performances et du
                référencement (SEO), ainsi que le débogage d’applications.
                <br />
                <br />
              </p>
        ...
        <div className="ensemble-contact">
          <div className="lien-icon-ensemble">
            <p className="paragraphe-contact">
              Pour me contacter vous avez à disposition mon adresse e-mail ainsi
              que mon Linkedin
            </p>
